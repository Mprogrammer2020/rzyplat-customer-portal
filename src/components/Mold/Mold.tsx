                        ...
                        <Col md={4}>
                            <div className="weather-outer-section">
                                ...
                                <Dropdown className="dropdown-main">
                                    ...
                                    <Dropdown.Menu>
                                        <Dropdown.Item href="#/action-1">Azalea Park Apartments
                                        </Dropdown.Item>
                                        <Dropdown.Item href="#/action-2">Magnolia Square</Dropdown.Item>
                                        <Dropdown.Item href="#/action-3">Park Place - FL</Dropdown.Item>
                                        <Dropdown.Item href="#/action-3">Westwood Apartments</Dropdown.Item>
                                        <Dropdown.Item href="#/action-3">Beldon Spring Lake</Dropdown.Item>
                                        <Dropdown.Item href="#/action-3">St James Place</Dropdown.Item>
                                        <Dropdown.Item href="#/action-3">Park Place Townhomes</Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                        </Col>
